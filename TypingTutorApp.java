...
//shared class variables
	...
	public static void setupGUI(int frameX,int frameY,int yLimit) {
		...
		gameWindow = new GamePanel(words,word,yLimit,done,started,won);
	...
	public static void createWordMoverThreads() {
		...
		word[0] = new HungryWordMover(dict.getNewWord(),xlimit,yLimit/2);

		//create threads to move them
	    for (int i=0;i<noWords;i++) {
		wrdShft[i] = new WordMover(words[i],word[0],dict,score,startLatch,done,pause);
	    }
